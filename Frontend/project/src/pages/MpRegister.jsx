...
const MpRegister = () => {
  ...
  const fields = [
    ...
    { label: 'Constituency Number', name: 'constituencyNumber', type: 'text' },
    { label: 'Constituency Name', name: 'constituencyName', type: 'text' },
        ...
        <div className="border border-[#0B3D62]/30 bg-white">
          <div className="bg-[#0B3D62]/5 border-b border-[#0B3D62]/30 px-6 py-4 text-center">
            ...
            <p className="text-xs text-[#5A5A5A] mt-1">
              Register your official representative account
            </p>
          </div>
